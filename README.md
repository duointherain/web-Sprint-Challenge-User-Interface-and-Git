...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    Semantic html uses tags that mean something. It's the difference between - say when you are asked what you want for lunch, Sandwich (semantic - section, nav), or Uhhhhh (Not semantic - div)

2. Name two big differences between ```display: block;``` and ```display: inline;```.
    
    block - top and bottom margins are used
    inline - they are not
...
4. While using flexbox, what axis does the following property work on: ```align-items: center```?
    the main axis, which in this case would be what we consider the y axis

5. Explain why git is valuable to a team of developers.
    It has version control, allows collaboration, and is industry standard
